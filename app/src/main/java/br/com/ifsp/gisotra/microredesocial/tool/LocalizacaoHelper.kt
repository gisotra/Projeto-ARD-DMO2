package br.com.ifsp.gisotra.microredesocial.tool
...
class LocalizacaoHelper(
        ...
        interface Callback {
            fun onLocalizacaoRecebida(endereco: Address, latitude: Double, longitude:
            Double)
        ...
        private fun obterEndereco(latitude: Double, longitude: Double, callback:
        Callback) {
                ...
                geocoder.getFromLocation(
                    ...
                    object : Geocoder.GeocodeListener {
                        override fun onGeocode(addresses: MutableList<Address>) {
                            if (addresses.size > 0) {
                                callback.onLocalizacaoRecebida(addresses[0], latitude,
                                    longitude)
                            } else {
